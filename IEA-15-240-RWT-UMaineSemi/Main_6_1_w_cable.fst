...
False                  MirrorRotor - Flag to reverse rotor rotation direction [1 to NRotors] {False=Normal, True=Mirror}
...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT-UMaineSemi_ElastoDyn_6.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string) 
...
"IEA-15-240-RWT_InflowWind_6_1.dat"          InflowFile   - Name of file containing inflow wind input parameters (quoted string) 
"IEA-15-240-RWT-UMaineSemi_AeroDyn.dat"  AeroFile     - Name of file containing aerodynamic input parameters (quoted string) 
...
"IEA-15-240-RWT-UMaineSemi_SeaState_6_1.dat" SeaStFile    - Name of file containing sea state input parameters (quoted string)
...
"IEA-15-240-RWT-UMaineSemi_MoorDyn_w_cable.dat"  MooringFile  - Name of file containing mooring system input parameters (quoted string) 
...
600.0                  TStart      - Time to begin tabular output (s)
